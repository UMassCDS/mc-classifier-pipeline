...
logging.config.dictConfig(
    {
        ...
        "root": {"level": os.getenv("LOG_LEVEL"), "handlers": ["console"], "propagate": True},
    }
)

# Import after logging is configured
from label_studio_ml.api import init_app  # noqa: E402
from model import SklearnTextClassifier  # noqa: E402
...
if __name__ == "__main__":
    ...
    app = init_app(
        model_class=SklearnTextClassifier, basic_auth_user=args.basic_auth_user, basic_auth_pass=args.basic_auth_pass
    )
